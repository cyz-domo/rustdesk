...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("amyuni_virtual_display_limit_tip", "With this virtual display driver, adding a second display makes the whole desktop stutter once per second, physical monitors included. RustDesk is plugging it in anyway."),
    ].iter().cloned().collect();
}

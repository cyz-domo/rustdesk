...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("amyuni_virtual_display_limit_tip", "This virtual display driver supports only one display. Adding a second one slows down the whole desktop, so please plug out the current virtual display first."),
    ].iter().cloned().collect();
}

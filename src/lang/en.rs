...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("amyuni_virtual_display_limit_tip", "This virtual display driver makes the whole desktop stutter once per second as soon as a second virtual display is added, and the remote frame rate drops with it. Your physical monitors stutter too. RustDesk adds this display anyway, but one virtual display is recommended."),
    ].iter().cloned().collect();
}
